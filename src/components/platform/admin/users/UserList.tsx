...
type SortField = 'name' | 'status' | 'membership' | null
...
export default function UserList({ users }: UserListProps) {
  ...
  const sortedUsers = [...users].sort((a, b) => {
    ...
    if (sortField === 'membership') {
      const aActive = isMembershipActive(a.membership) ? 1 : 0
      const bActive = isMembershipActive(b.membership) ? 1 : 0
      return sortOrder === 'asc' ? bActive - aActive : aActive - bActive
    }
      ...
      <div className="p-4 border-b bg-muted/20 flex flex-col sm:flex-row gap-4 justify-between items-stretch sm:items-center">
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto items-stretch sm:items-center">
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="status-asc">Estado: Activos primero</SelectItem>
              <SelectItem value="status-desc">Estado: Inactivos primero</SelectItem>
              <SelectItem value="membership-asc">Membresía: Activas primero</SelectItem>
              <SelectItem value="membership-desc">Membresía: Inactivas primero</SelectItem>
        ...
        <div className="flex gap-4 text-xs text-muted-foreground self-end sm:self-center">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div>
                  ...
                  {user.phoneNumber ? (
                    ...
                    >
                      <FaWhatsappSquare className="h-4 w-4" />
                      {user.phoneNumber}
                    </Link>
                  ) : null}
                </div>
          ...
          <thead className="text-xs text-muted-foreground uppercase bg-muted/50">
            <tr className="select-none">
              ...
              <th
                ...
                title="Ordenar por estado de usuario"
              >
              ...
              <th
                ...
                title="Ordenar por estado de membresía"
              >
                <div className="flex items-center justify-center gap-1.5">
                  <span>Membresía</span>
