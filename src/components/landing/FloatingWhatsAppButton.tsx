  ...
  return (
    <div className={`${isVisible ? 'fade-in pointer-events-auto' : 'opacity-0  pointer-events-none'}`}>
      ...
      <motion.a
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-12 h-12 bg-[#25D366] text-white rounded-full shadow-lg hover:bg-[#1DA851] focus:outline-none focus:ring-4 focus:ring-[#25D366]/50"
